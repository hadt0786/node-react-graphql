/**Graph ql schema folder name should match the route */
...
/**create a GraphQL query type that calls a list of book and single book by ID. */
...
/**exports this file as GraphQL schema by adding this line at the end of the file. */


/**Add Mutation for CRUD Operation to the Schema
 * 
 * For completing CRUD (Create, Read, Update, Delete) 
 * operation of the GraphQL, we need to add a mutation 
 * that contains create, update and delete operations.
 *  Open and edit `server/graphql/bookSchemas.js` 
